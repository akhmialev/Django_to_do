    ...
    if request.method == 'GET':
        ...
        if request.POST['password1'] == request.POST['password2']:
            try:
                ...
                return render(request, 'signupuser.html', context={'form': UserCreationForm,
...
def createdtodo(request):
    if request.method == "GET":
        return render(request, 'createdtodo.html', {'form': TodoForm()})
    else:
        try:
            ...
            return render(request, 'createdtodo.html', {'form': TodoForm(), 'error': 'Dab data passed in'})
...
def todo(request, todo_pk):
    ...
    if request.method == "GET":
        ...
        try:
            ...
            return render(request, 'todo.html', {'todo': todo, 'form': form, 'error': "Bad info"})
